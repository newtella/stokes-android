...
import com.codigogt.stokes.ui.AppointmentAdapter
...
class AccountDObjectFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        appointments.add(
            Appointment(1, "Dr. Dorian Jimenez", "22/06/2020", "07:00 AM", "1")
        )
        appointments.add(
            Appointment(2, "Dr. Henry Velasquez", "22/06/2020", "09:00 AM", "2")
        )
        appointments.add(
            Appointment(3, "Dr. Tomas Cardona", "22/06/2020", "03:00 PM", "3")
        )
